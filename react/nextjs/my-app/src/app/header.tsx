...
function NavList() {
  return (
    <ul className="my-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        <a href="test" className="flex items-center hover:text-blue-500 transition-colors">
          Test
        </a>
      </Typography>
      <Typography
      ...
      <Typography
        ...
        className="p-1 font-medium"
      >
        <a href="/debug" className="flex items-center hover:text-blue-500 transition-colors">
          Debug
        </a>
      </Typography>
      <Typography
